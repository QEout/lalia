...
import 'package:lalia/pages/community/community_page.dart';

import 'package:lalia/pages/password/password_page.dart';
import 'package:lalia/pages/card/card_page.dart';
import 'package:lalia/pages/classification/classification_page.dart';
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
              ...
              title: Text("社区", style: TextStyle(fontSize: 12))),
          BottomNavigationBarItem(
              icon: Icon(
                Icons.settings,
              ),
